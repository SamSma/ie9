...
import MasterBody from "../../components/case/masterBody"
...
export default  class Master extends Component {
    render() {
        ...
        this.state={
            ...
            nav:[{title:"我的首页",icon:shouye,route:"/caseright"},{title:"我的订单",icon:dingdan,route:""},
