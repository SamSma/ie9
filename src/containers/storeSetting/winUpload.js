...
export default class WinUpload extends Component{
    render(){
        return(
            <div>
                <div className="basicInfoCon">
                    ...
                    <div className="basicPanel">
                        <div className="basicViceTil">
                            <span className="basicTilWz">奖项名称</span>
                        </div>
                    ...
                    <div className="basicPanel">
                        <div className="basicViceTil">
                            <span className="basicTilWz">获奖描述</span>
                        </div>
                        <div className="basicCon">
                            <Ueditor />
                        </div>
                    ...
                    <div className="basicPanel">
                        <div className="basicViceTil">
                            <span className="basicTilWz">获奖时间</span>
                        </div>
                    ...
                    <div className="basicPanel">
                        ...
                        <div className="basicCon basicUploadWin">
                            ...
                            <div className="basicWinPreview">
                                <img src={require("../../common/images/baseshop/defaultImg.png")} alt="获奖证书外页"/>
                    ...
                    <div className="basicPanel">
                        <div className="basicViceTil">
                            <span className="basicTilWz">上传获奖产品图片</span>
                        </div>
                        <div className="basicCon basicUploadWin">
                            <div className="basicWinCon">
                                <div className="basinWinEvent">
                            ...
                            <div className="basicWinPreview">
                                <img src={require("../../common/images/baseshop/defaultImg.png")} alt="获奖产品图片"/>
                                <div className="basicPreviewDel">
                                    <a>删除</a>
                                </div>
                            </div>
